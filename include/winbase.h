...
WINBASEAPI void        WINAPI EnterCriticalSection(CRITICAL_SECTION *lpCrit) __WINE_ACQUIRE(lpCrit);
...
WINBASEAPI void        WINAPI LeaveCriticalSection(CRITICAL_SECTION *lpCrit) __WINE_RELEASE(lpCrit);
...
WINBASEAPI BOOL        WINAPI SleepConditionVariableCS(PCONDITION_VARIABLE,PCRITICAL_SECTION cs,DWORD) __WINE_REQUIRES(cs);
...
WINBASEAPI BOOL        WINAPI TryEnterCriticalSection(CRITICAL_SECTION *lpCrit) __WINE_TRY_ACQUIRE(TRUE,lpCrit);
