...
static BOOL test_WM_NOTIFY_expect_CBEN_ENDEDITW;
...
static LRESULT parent_wnd_notify(WPARAM wParam, LPARAM lParam)
{
    ...
    {
        case CBEN_ENDEDITW:
            if (test_WM_NOTIFY_expect_CBEN_ENDEDITW)
            {
                test_WM_NOTIFY_expect_CBEN_ENDEDITW = FALSE;
...
static void test_WM_NOTIFY(void)
{
    ...
    test_WM_NOTIFY_expect_CBEN_ENDEDITW = TRUE;
